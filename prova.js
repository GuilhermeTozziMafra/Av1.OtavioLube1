...
const App = () => {
  const items = [
    ...
    },
    {
      id: 2,
      name: 'Anel de Dorian',
      description: 'O anel de Dorian é uma relíquia lendária, que foi forjada em tempos antigos por um grande mago, ele da dano de gelo, além dele dobrar o seu dano',
      image:
    ...
    },
    {
      ...
      description: 'Os Brincos de Ouro são joia mágica que emite um brilho suave e misterioso. São brincos que fazem parte de um comum traje de treinamento mas com propriedade para 2 usuarios se fundirem',
      image:
